...
This means that the string (`'Welcome to Math for ML!'`) is a 23-character (23) unicode string (`U`) on a little-endian architecture (`<`). You can learn more about data types [here](https://docs.scipy.org/doc/NumPy-1.13.0/reference/arrays.dtypes.html).
...
```
    ...
    [0.52649438 0.77712451 0.73316068]
...
![0_Vh-pKXTJsdL-9FT0.png](C1_W1_Lab_1_introduction_to_numpy_arrays_files/0_Vh-pKXTJsdL-9FT0.png)
...
![Unknown-2.png](C1_W1_Lab_1_introduction_to_numpy_arrays_files/Unknown-2.png)
