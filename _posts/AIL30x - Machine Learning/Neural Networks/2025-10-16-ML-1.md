...
- [1. Introduction to Machine Learning](#1-introduction-to-machine-learning)
  - [1.1. What is a (Neural Network) NN?](#11-what-is-a-neural-network-nn)
  - [1.2. Supervised learning with neural networks](#12-supervised-learning-with-neural-networks)
  - [1.3. Why is deep learning taking off?](#13-why-is-deep-learning-taking-off)
- [2. Neural Networks Basics](#2-neural-networks-basics)
  - [2.1. Binary classification](#21-binary-classification)
  - [2.2. Logistic regression](#22-logistic-regression)
  - [2.3. Logistic regression cost function](#23-logistic-regression-cost-function)
  - [2.4. Gradient Descent](#24-gradient-descent)
  - [2.5. Derivatives](#25-derivatives)
  - [2.6. More Derivatives examples](#26-more-derivatives-examples)
  - [2.7. Computation graph](#27-computation-graph)
  - [2.8. Derivatives with a Computation Graph](#28-derivatives-with-a-computation-graph)
  - [2.9. Logistic Regression Gradient Descent](#29-logistic-regression-gradient-descent)
  - [2.10. Gradient Descent on m Examples](#210-gradient-descent-on-m-examples)
  - [2.11. Vectorization](#211-vectorization)
  - [2.12. Vectorizing Logistic Regression](#212-vectorizing-logistic-regression)
  - [2.13. Notes on Python and NumPy](#213-notes-on-python-and-numpy)
  - [2.14. General Notes](#214-general-notes)
- [3. Shallow neural networks](#3-shallow-neural-networks)
  - [3.1. Neural Networks Overview](#31-neural-networks-overview)
  - [3.2. Neural Network Representation](#32-neural-network-representation)
  - [3.3. Computing a Neural Network's Output](#33-computing-a-neural-networks-output)
  - [3.4. Vectorizing across multiple examples](#34-vectorizing-across-multiple-examples)
  - [3.5. Activation functions](#35-activation-functions)
  - [3.6. Why do you need non-linear activation functions?](#36-why-do-you-need-non-linear-activation-functions)
  - [3.7. Derivatives of activation functions](#37-derivatives-of-activation-functions)
  - [3.8. Gradient descent for Neural Networks](#38-gradient-descent-for-neural-networks)
  - [3.9. Random Initialization](#39-random-initialization)
- [4. Deep Neural Networks](#4-deep-neural-networks)
  - [4.1. Deep L-layer neural network](#41-deep-l-layer-neural-network)
  - [4.2. Forward Propagation in a Deep Network](#42-forward-propagation-in-a-deep-network)
  - [4.3. Getting your matrix dimensions right](#43-getting-your-matrix-dimensions-right)
  - [4.4. Why deep representations?](#44-why-deep-representations)
  - [4.5. Building blocks of deep neural networks](#45-building-blocks-of-deep-neural-networks)
  - [4.6. Forward and Backward Propagation](#46-forward-and-backward-propagation)
  - [4.7. Parameters vs Hyperparameters](#47-parameters-vs-hyperparameters)
  - [4.8. What does this have to do with the brain](#48-what-does-this-have-to-do-with-the-brain)
...
- Simple NN graph:
  ...
  ![](/assets/img/machine-learning/Others/01.jpg)
...
- Deep NN consists of more hidden layers (Deeper layers)
  ...
  ![](/assets/img/machine-learning/Others/02.png)
...
- Deep learning is taking off for 3 reasons:
  ...
  ![](/assets/img/machine-learning/11.png)
  ...
  - ASICs
  1. Algorithm: Creative algorithms has appeared that changed the way NN works.
...
![log](/assets/img/machine-learning/Others/03.png)
...
![](/assets/img/machine-learning/02.png)
...
![](/assets/img/machine-learning/03.png)
...
![](/assets/img/machine-learning/04.png)
...
![](/assets/img/machine-learning/09.png)
...
![](/assets/img/machine-learning/05.png)
...
![](/assets/img/machine-learning/06.png)
...
![](/assets/img/machine-learning/07.png)
...
![Untitled](/assets/img/machine-learning/10.png)

- Deep NN blocks:

![](/assets/img/machine-learning/08.png)
...
<!-- ## 4.9. Extra: Ian Goodfellow interview
