...
- [1. Practical aspects of Deep Learning](#1-practical-aspects-of-deep-learning)
  - [1.1 Train / Dev / Test sets](#11-train--dev--test-sets)
  - [1.2 Bias / Variance](#12-bias--variance)
  - [1.3 Basic Recipe for Machine Learning](#13-basic-recipe-for-machine-learning)
  - [1.4 Regularization](#14-regularization)
  - [1.5 Why regularization reduces overfitting?](#15-why-regularization-reduces-overfitting)
  - [1.6 Dropout Regularization](#16-dropout-regularization)
  - [1.7 Understanding Dropout](#17-understanding-dropout)
  - [1.8 Other regularization methods](#18-other-regularization-methods)
  - [1.9 Normalizing inputs](#19-normalizing-inputs)
  - [1.10 Vanishing / Exploding gradients](#110-vanishing--exploding-gradients)
  - [1.11 Weight Initialization for Deep Networks](#111-weight-initialization-for-deep-networks)
  - [1.12 Numerical approximation of gradients](#112-numerical-approximation-of-gradients)
  - [1.13 Gradient checking implementation notes](#113-gradient-checking-implementation-notes)
  - [1.14 Initialization summary](#114-initialization-summary)
  - [1.15 Regularization summary](#115-regularization-summary)
    - [a) L2 Regularization](#a-l2-regularization)
    - [b) Dropout](#b-dropout)
- [2. Optimization algorithms](#2-optimization-algorithms)
  - [2.1 Mini-batch gradient descent](#21-mini-batch-gradient-descent)
  - [2.2 Understanding mini-batch gradient descent](#22-understanding-mini-batch-gradient-descent)
  - [2.3 Exponentially weighted averages](#23-exponentially-weighted-averages)
  - [2.4 Understanding exponentially weighted averages](#24-understanding-exponentially-weighted-averages)
  - [2.5 Bias correction in exponentially weighted averages](#25-bias-correction-in-exponentially-weighted-averages)
  - [2.6 Gradient descent with momentum](#26-gradient-descent-with-momentum)
  - [2.7 RMSprop](#27-rmsprop)
  - [2.8 Adam optimization algorithm](#28-adam-optimization-algorithm)
  - [2.9 Learning rate decay](#29-learning-rate-decay)
  - [2.10 The problem of local optima](#210-the-problem-of-local-optima)
- [3. Hyperparameter tuning, Batch Normalization and Programming Frameworks](#3-hyperparameter-tuning-batch-normalization-and-programming-frameworks)
  - [3.1 Tuning process](#31-tuning-process)
  - [3.2 Using an appropriate scale to pick hyperparameters](#32-using-an-appropriate-scale-to-pick-hyperparameters)
  - [3.3 Hyperparameters tuning in practice: Pandas vs. Caviar](#33-hyperparameters-tuning-in-practice-pandas-vs-caviar)
  - [3.4 Normalizing activations in a network](#34-normalizing-activations-in-a-network)
  - [3.5 Fitting Batch Normalization into a neural network](#35-fitting-batch-normalization-into-a-neural-network)
  - [3.6 Why does Batch normalization work?](#36-why-does-batch-normalization-work)
  - [3.7 Batch normalization at test time](#37-batch-normalization-at-test-time)
  - [3.8 Softmax Regression](#38-softmax-regression)
  - [3.9 Training a Softmax classifier](#39-training-a-softmax-classifier)
  - [3.10 Deep learning frameworks](#310-deep-learning-frameworks)
  - [3.11 TensorFlow](#311-tensorflow)
...
- So here the explanation of Bias / Variance:
  ...
  ![](/assets/img/machine-learning/01-_Bias_-_Variance.png)
...
- **Early stopping**:
  ...
  - We will take these parameters as the best parameters.
    - ![](/assets/img/machine-learning/02-_Early_stopping.png)
...
- There's a numerical way to calculate the derivative:   
  ![](/assets/img/machine-learning/03-_Numerical_approximation_of_gradients.png)
...
- In mini-batch algorithm, the cost won't go down with each step as it does in batch algorithm. It could contain some ups and downs but generally it has to go down (unlike the batch gradient descent where cost function descreases on each iteration).
  ![](/assets/img/machine-learning/04-_batch_vs_mini_batch_cost.png)
- Mini-batch size:
...
<!-- - Another imagery example:   
    ![](/assets/img/machine-learning/Nasdaq1_small.png)   
    _(taken from [investopedia.com](https://www.investopedia.com/))_ -->

### 2.4 Understanding exponentially weighted averages

- Intuitions:   
    ![](/assets/img/machine-learning/05-_exponentially_weighted_averages_intuitions.png)
...
- RMSprop will make the cost function move slower on the vertical direction and faster on the horizontal direction in the following example:
    ...
    ![](/assets/img/machine-learning/06-_RMSprop.png)
...
- Using batch norm in 3 hidden layers NN:
    ![](/assets/img/machine-learning/bn.png)
...
- Example:
  ...
  ![](/assets/img/machine-learning/07-_softmax.png)
